                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-desi">
                                    <form class="needs-validation"
                                        action="{{ route('dashboard.categories.update', $mainCategories->id) }}" method="POST"
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="validationCustom01" type="text"
                                                    name="name" value="{{ $mainCategories->name }}">
                                            </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input class="form-control dropify" id="validationCustom02" type="file"
                                                    name="image" data-default-file="{{ asset($mainCategories->image) }}">
                                            </div>
